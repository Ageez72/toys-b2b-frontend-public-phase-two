...
export default function PaymentForm() {
  ...
  const formatCCV = (value) => value.replace(/\D/g, "").slice(0, 3);
        ...
        <div className={`w-full lg:w-1/2 ${
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="flex h-10 w-full rounded-md border-2 px-4 py-1.5 text-lg focus-visible:border-purple-600"
              maxLength="19"
          ...
          <div className="w-full max-w-sm h-56" style={{ perspective: "1000px" }}>
            <div
              ...
              style={{
                ...
                transform: seeBack ? "rotateY(-180deg)" : "rotateY(0deg)",
              }}
                ...
                <div className="w-full px-8 absolute top-8">
                  ...
                  <div className={`pt-6 flex justify-between ${dir === "rtl" ? "flex-row-reverse text-end" : ""}`}>
                    ...
                    <div>
                      ...
                      <p className="font-medium tracking-wider h-6">{expDate}</p>
                    </div>
                  </div>
                </div>
              </div>
