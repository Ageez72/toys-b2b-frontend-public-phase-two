...
export default function MobileHomeLoader() {
    return (
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 w-full">
            <div role="status" className="max-w-sm p-4 rounded-sm animate-pulse md:p-6 dark:border-gray-700">
                <div className="flex items-center justify-center h-48  bg-gray-300 rounded-sm dark:bg-gray-700">
